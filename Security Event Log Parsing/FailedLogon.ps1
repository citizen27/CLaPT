...
if ($logonfailEvents.Count -eq 0) {
    ...
    $logoffEvents | Select-Object TimeCreated, @{Name = "User"; Expression = { $_.Properties[5].Value } } | Export-Csv -Path "$home\Desktop\CLaPT_Output\Failed_Logon_Events.csv" -NoTypeInformation
