# Specify the directory containing CloudFiles ETL logs
$etlDirectory = "C:\Windows\System32\LogFiles\CloudFiles\"

# Specify the output directory for CSV files
$outputDirectory = "$home\Desktop\CLaPT_Output\CloudFiles"
...
# Set the working directory to the CloudFiles ETL logs directory
